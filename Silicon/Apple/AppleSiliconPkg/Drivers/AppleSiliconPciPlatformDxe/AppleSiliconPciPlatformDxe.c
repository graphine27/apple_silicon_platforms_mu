...
) 
{
    ...
    dt_node_reg(ApcieNode, 0, &PcieComplexInfoStruct->EcamCfgRegionBase, NULL);
    PcieComplexInfoStruct->EcamCfgRegionSize = dt_node_u32(ApcieNode, "reg", 2);//TODO: check and improve
